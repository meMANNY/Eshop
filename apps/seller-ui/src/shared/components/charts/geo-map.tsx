...
/*
  User count is a sequential quantity, so the ramp is one hue at rising strength.
  It moves off coral because coral is the interface accent here — buttons, the
  active nav, focus rings — and a shaded country should not wear the same colour
  as a control. Every step is checked to clear 3:1 against the panel behind it, so
  the lowest band still reads as data rather than as "no data".
*/
const BANDS = [
            ...
            {tooltip && (
              ...
              >
                ...
                <div className="mt-1 text-[var(--muted)]">
                  Users{" "}
                  <span className="figure text-[var(--text)]">{tooltip.users}</span>
                </div>
