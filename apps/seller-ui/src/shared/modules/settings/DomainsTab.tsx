  ...
  return (
    <div className="max-w-3xl space-y-5">
      ...
      <Panel>
        ...
        <div className="flex items-center gap-2.5 px-5 py-5 text-sm text-[var(--muted)]">
          <Globe size={16} className="text-[var(--faint)]" aria-hidden="true" />
      ...
      <Panel>
        ...
        <div className="space-y-3 p-5">
          <div className="rounded-lg border border-rule bg-raised p-4">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-sm font-medium text-[var(--text)]">CNAME</p>
              ...
              <button
                type="button"
                onClick={copyCname}
                className="inline-flex items-center gap-1.5 rounded-md border border-rule px-2 py-1 text-xs text-[var(--text)] transition-colors hover:border-coral/50"
              >
                {copied ? (
                  <>
            ...
            <Figure className="mt-2 block text-sm text-coral-bright">
              {CNAME_TARGET}
            </Figure>
          </div>
          ...
          */}
          <div className="rounded-lg border border-dashed border-rule p-4">
            <p className="text-sm font-medium text-[var(--text)]">A record</p>
            <p className="mt-0.5 text-xs text-[var(--muted)]">
        ...
        <p className="border-t border-rule px-5 py-3 text-xs text-[var(--faint)]">
