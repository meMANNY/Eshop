        ...
        <div className = "w-full flex justify-center">
            <div className = "md:w-[480px] p-8 bg-white shadow rounded-lg">
                ...
                <p className = "text-center text-[#00000099] mb-6">
                        Don't have an account? <Link href="/signup" className = "text-[#ff6f61] cursor-pointer">Sign Up</Link>
                </p>
                ...
                <form onSubmit = {handleSubmit(onSubmit)}>
                        ...
                        <div className = "flex justify-between items-center my-4">
                                ...
                                <Link href="/forgot-password" className="text-[#ff6f61] text-sm hover:underline">
                                    Forgot Password?
                                </Link>
                        </div>
                        <button
