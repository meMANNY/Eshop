 ...
 *
 * Because each bar is directly labelled with its own name and percentage, colour
 * carries no identity here, so the chart needs exactly one hue instead of the
 * green/amber/blue trio it had. That trio was also borrowing the reserved status
 * colours, so a device category read like a payment state.
 */
